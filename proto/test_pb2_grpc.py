...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                ...
                response_deserializer=test__pb2.HelloResponse.FromString,
                )
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=test__pb2.HelloResponse.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Greeter/SayHello',
            ...
            test__pb2.HelloResponse.FromString,
