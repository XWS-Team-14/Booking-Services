...
class User:
    ...
    async def update_user_details(self, payload: schemas.UserDetailsUpdate, access_token: Annotated[str | None, Cookie()] = None) -> Response:
    ...
    async def login(self, payload: schemas.Login) -> None:
        logger.info(f"Tested delete user {payload.email}")