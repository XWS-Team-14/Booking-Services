            ...
            if message.value['action'] == 'commit':
                ...
                if message.value['item']:
                    ...
                    if not item:
                        ...
                        logger.success("Deleted User successfully saved")
                ...
                deleted_user = await DeletedUser.find(
                    DeletedUser.transaction_id == uuid.UUID(message.value['transaction_id'])).first_or_none()
                if deleted_user:
